...
export const AppFilesController = appFilesController(resolveProductAppScope)
export const WorkspaceFilesController = appFilesController(resolveWorkspaceAppScope)
