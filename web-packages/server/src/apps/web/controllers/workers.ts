...
export const AppWorkersController = workersController(resolveProductAppScope)
export const WorkspaceWorkersController = workersController(resolveWorkspaceAppScope)
